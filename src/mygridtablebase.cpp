    ...
    myGridTableBase::myGridTableBase(int rows, int cols):rows(rows),cols(cols)
    {
    ...
    int myGridTableBase::GetNumberRows()
    {
       return rows;
    }

    int myGridTableBase::GetNumberCols()
    {
       return cols;
    }

    bool myGridTableBase::IsEmptyCell(int x, int y)
    {
       return false;
    }
